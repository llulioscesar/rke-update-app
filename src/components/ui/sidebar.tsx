import { type Component, type JSX, createContext, useContext, createSignal, createMemo, onMount, onCleanup, splitProps } from "solid-js"
...
function SidebarMenuButton(props: SidebarMenuButtonProps) {
  ...
  // Lógica simple: si tiene href o asChild, es un enlace; si no, es un botón
  ...
  const tooltipProps = typeof local.tooltip === "string" 
